    ...
    return [
        {
            ...
            password: process.env.SUPER_ADMIN_1_PASSWORD || '***REMOVED***'
        },
        {
            ...
            password: process.env.SUPER_ADMIN_2_PASSWORD || '***REMOVED***'
        },
        {
            ...
            password: process.env.SUPER_ADMIN_3_PASSWORD || '***REMOVED***'
        }
    ];
}
